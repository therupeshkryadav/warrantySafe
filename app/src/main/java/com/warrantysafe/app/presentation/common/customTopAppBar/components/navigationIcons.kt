...
fun navigationIcons(
    ...
    val navigationIcon = when (currentRoute) {
        ...
        Route.SearchScreen.route,Route.ProductList.route, Route.NotificationScreen.route, Route.ProductDetailsScreen.route, Route.EditProfileScreen.route, Route.EditProductDetailsScreen.route -> {
            NavigationIconConfig(
