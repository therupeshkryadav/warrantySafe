...
fun ExpiredTab(
    ...
    val expiredState = productViewModel.expiredProductsState.observeAsState()
    val expiredProducts = expiredState.value?.getOrNull() as? List<Product> ?: emptyList() // Safe casting and defaulting to empty list
