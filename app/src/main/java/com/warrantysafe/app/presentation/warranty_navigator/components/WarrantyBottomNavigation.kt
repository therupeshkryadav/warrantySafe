...
@Composable
fun WarrantyBottomNavigationPreview() {
    WarrantySafeTheme (dynamicColor = false) {
        WarrantyBottomNavigation(items = listOf(
            BottomNavigationItem(icon = R.drawable.home_warranty, text = "Home"),
            BottomNavigationItem(icon = R.drawable.search_warranty, text = "Search"),
            ...
            BottomNavigationItem(icon = R.drawable.settings_warranty, text = "Settings"),
